...
public class Section {
    ...
    public Section(SectionId id, ProviderSectionId providerSectionId, Airline marketingCarrier, Airline operatingCarrier, Airport departureAirport, Airport arrivalAirport, LocalDateTime departureDate, LocalDateTime arrivalDate, int flightNumber, String pnr) {
        this.id = id;
